...
public class ProductRepository : EfRepository<Product>, IProductRepository
{
  ...
  public async Task<Product> CreateProductAsync(IProduct product, CancellationToken cancellationToken)
  {
  ...
  public async Task<Product> UpdateProductAsync(IProduct updatedProduct, CancellationToken cancellationToken)
  {
